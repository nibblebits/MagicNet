...
#define MAGICNET_CLIENT_TIMEOUT_SECONDS 2
...
#define MAGICNET_IDEAL_DATA_TRANSFER_BYTE_RATE_PER_SECOND 200000000
#define MAGICNET_IDEAL_DATA_TRANSFER_BYTE_RATE_WHEN_PROCESSING_PACKETS 1000000
