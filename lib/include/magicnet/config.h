...
#define MAGICNET_CLIENT_TIMEOUT_SECONDS 60

// Force a ping after 30 seconds if theres been no activity in this time.
#define MAGICNET_CLIENT_FORCE_PING_SECONDS 30
...
// 1 Mb MAX
#define MAGICNET_magicnet_request_input_data_MAXIMUM_SIZE 1048576
// Upto 1 GB because the data can be excessive that we are requesting
// a better design may be to buffer this later on..
#define MAGICNET_magicnet_request_response_output_data_MAXIMUM_SIZE 1048576*1024
...
// 365 days
#define MAGICNET_DEFAULT_COUNCIL_CERTIFICATE_LIFETIME 86400 * 365
